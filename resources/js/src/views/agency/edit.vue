<template>
    <div>
        <div v-if="can('edit-agency')||$store.getters['auth/userData'].id===$route.params.id" class="vx-col w-full mb-base">
            <vx-card ref="edit" title="Edit Agency">
                ...
                <vs-row vs-align="center" vs-type="flex" vs-justify="center" vs-w="12">
                    <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="12">
                        <vs-button id="btn-edit" :disabled="!validateForm" @click="is_requesting?$store.dispatch('viewWaitMessage', $vs):edit()" icon-pack="feather" icon="icon-save" type="gradient">Edit Agency</vs-button>
                    </vs-col>
                </vs-row>
            </vx-card>
        </div>
    ...
    export default {
        ...
        methods: {
            getAgencyData() {
                this.$store.dispatch('agency/view', this.$route.params.id)
                    .then(response => {
                        ...
                        this.uploadedImage = this.form.image && this.form.image.url?this.form.image.url:'/images/avatar-s-11.png';
            ...
            edit() {
                ...
                this.$store.dispatch('agency/update', {id: this.$route.params.id, data: form_data})
                    .then(response => {
