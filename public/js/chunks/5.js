  ...
  methods: {
    getCategoryCombinations: function getCategoryCombinations() {
      ...
      this.$store.dispatch('combination/getData', "?category=".concat(this.catId)).then(function (response) {
        _this.categoryCombination = response.data.data;
        console.log('category Combinations: ', _this.categoryCombination);
      }).catch(function (error) {
        console.log(error);
      ...
      _c(
        ...
        [
          ...
          _vm.form.category_id
            ? _c("Combinations", {
                attrs: {
                  categoryId: _vm.form.category_id,
                  priceCombinations: _vm.$route.params.id
                }
              })
            : _vm._e()
        ],
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _ShowSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _ShowSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
