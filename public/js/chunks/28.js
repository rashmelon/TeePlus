...
/* harmony import */ var _product_combintaions_ShowSingle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../product_combintaions/ShowSingle */ "./resources/js/src/views/product_combintaions/ShowSingle.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Combinations: _product_combintaions_ShowSingle__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  props: {
    payload: {
      required: false,
  ...
  methods: {
    getCategories: function getCategories() {
      ...
      this.$store.dispatch('category/getData', this.payload).then(function (response) {
        _this.categories = response.data.data; // get priceCombinations of every category seperately

        _this.categories.forEach(function (cat) {
          _this.getCombinations(cat.id);
        });

        _this.$vs.loading.close(_this.$refs.edit.$el);
    ...
    getCombinations: function getCombinations(catId) {
      var _this2 = this;

      this.$store.dispatch('combination/getData', "?category=".concat(catId)).then(function (response) {
        // console.log(`combination for cat id = ${catId}`)
        // console.log(response.data.data)
        for (var index = 0; index < _this2.categories.length; index++) {
          if (_this2.categories[index].id == catId) {
            _this2.categories[index].priceCombinations = response.data.data;
          }
        }
      }).catch(function (error) {
        console.log(error);
    ...
    getProduct: function getProduct() {
      ...
      this.$store.dispatch('product/view', this.$route.params.id).then(function (response) {
        _this3.form = response.data.data; // preview used image

        if (_this3.form.image) {
          _this3.uploadedImage = _this3.form.image.url;
        }
      }).catch(function (error) {
        console.log(error);
    ...
    edit: function edit() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          ...
          _this4.is_requesting = true; // edit new object for sending object without extra data

          var form_data = new FormData();

          for (var key in _this4.form) {
            if (key === 'image') {
              form_data.append(key, _this4.form[key][0]);
            } else {
              form_data.append(key, _this4.form[key]);
            }
          }

          _this4.$store.dispatch('product/update', {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getProductCombinations: function getProductCombinations() {
      var _this = this;

      console.log('product Id: ' + this.prodId);
      this.$store.dispatch('combination/getData', "?product=".concat(this.prodId)).then(function (response) {
        _this.productCombinations = response.data.data;
        console.log('product Combinations: ', _this.productCombinations);
      }).catch(function (error) {
        console.log(error);
    ...
    getCategoryCombinations: function getCategoryCombinations() {
      var _this2 = this;
      ...
      this.$store.dispatch('combination/getData', "?category=".concat(this.catId)).then(function (response) {
        _this2.categoryCombination = response.data.data;
        console.log('category Combinations: ', _this2.categoryCombination);
      }).catch(function (error) {
        console.log(error);
      ...
      _c(
        ...
        [
              ...
              _c(
                ...
                [
                  _c("vs-input", {
                    ...
                    on: { change: _vm.resetCombinations },
                    model: {
          ...
          _vm.form.category_id
            ? _c("Combinations", {
                attrs: {
                  catId: _vm.form.category_id,
                  prodId: _vm.$route.params.id
                }
              })
            : _vm._e()
        ],
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true&":
/*!*********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true& ***!
  \*********************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass: "my-5",
          attrs: { "collapse-action": "", title: "Combinations" }
        },
        [
          _c(
            "vs-select",
            {
              ...
              model: {
                value: _vm.productCombinations,
                callback: function($$v) {
                  _vm.productCombinations = $$v
                },
                expression: "productCombinations"
              }
            },
            _vm._l(_vm.categoryCombination, function(item, index) {
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  attrs: { color: "primary", type: "filled" },
                  on: { click: _vm.updateCombination }
                },
                [_vm._v("Edit compination")]
              )
            ],
            1
          )
...
/***/ "./resources/js/src/views/product_combintaions/ShowSingle.vue":
/*!********************************************************************!*\
  !*** ./resources/js/src/views/product_combintaions/ShowSingle.vue ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true& */ "./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true&");
/* harmony import */ var _ShowSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ShowSingle.vue?vue&type=script&lang=js& */ "./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "45e1d74c",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/product_combintaions/ShowSingle.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true&":
/*!***************************************************************************************************************!*\
  !*** ./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true& ***!
  \***************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/product_combintaions/ShowSingle.vue?vue&type=template&id=45e1d74c&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowSingle_vue_vue_type_template_id_45e1d74c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
