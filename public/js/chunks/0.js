                ...
                [
                  _c(
                    "vs-table",
                    {
                      ...
                      on: { selected: _vm.selectFromStock },
                      scopedSlots: _vm._u(
                        [
                          {
                            key: "default",
      ...
      [
        _c(
          "vs-button",
          {
            staticClass: "mb-4",
            attrs: {
              disabled: !_vm.order.orderProducts.length,
              color: "primary",
              icon: "icon-save",
              "icon-pack": "feather",
              type: "filled"
