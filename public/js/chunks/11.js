                    ...
                    return _vm._l(data, function(design, index) {
                      return _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: design.description } }, [
                            _vm._v(
                              "\n                        " +
                                _vm._s(design.description) +
                                "\n                    "
                            )
                          ]),
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: design.base_price } }, [
                            _vm._v(
                              "\n                        " +
                                _vm._s(design.base_price) +
                                "\n                    "
                            )
                          ]),
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: design.created_at } }, [
                            _vm._v(
                              "\n                        " +
                                        ...
                                        ? _c("vs-button", {
                                            ...
                                            on: {
                                              click: function($event) {
                                                return _vm.viewDesign(design.id)
                                              }
                                            }
                                          })
                                        : _vm._e()
                                    ...
                                    [
                                      _vm.can("edit-design")
                                        ? _c("vs-button", {
                                            ...
                                            on: {
                                              click: function($event) {
                                                return _vm.editDesign(design.id)
                                              }
                                            }
                                          })
                                        : _vm._e()
