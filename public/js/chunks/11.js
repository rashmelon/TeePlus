              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(ref) {
                    var data = ref.data
                    return _vm._l(_vm.packages, function(packageData, index) {
                      return _c(
                        "vs-tr",
                        { key: index },
                        [
                          _c("vs-td", { attrs: { data: packageData.id } }, [
                            _vm._v(
                              "\n                        " +
                          ...
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: packageData.title } }, [
                            _vm._v(
                              "\n                        " +
                          ...
                          "Super Admin"
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: packageData.date } }, [
                            _vm._v(
                              "\n                        " +
                          ...
                          _vm._v(" "),
                          _c("vs-td", { attrs: { data: packageData.price } }, [
                            _vm._v(
                              "\n                        " +
                                            ...
                                            "vs-switch",
                                            {
                                              ...
                                              on: {
                                                click: function($event) {
                                                  return _vm.agencyClose(index)
                                                }
                                              },
                                              model: {
                                                value: packageData.agency_close,
                                                callback: function($$v) {
                                                  _vm.$set(
                                                    packageData,
                                                    "agency_close",
                                        ...
                                        [
                                          _c(
                                            "vs-switch",
                                            {
                                              ...
                                              on: {
                                                click: function($event) {
                                                  return _vm.adminClose(index)
                                                }
                                              },
                                              model: {
                                                value: packageData.admin_close,
                                                callback: function($$v) {
                                                  _vm.$set(
                                                    packageData,
                                                    "admin_close",
